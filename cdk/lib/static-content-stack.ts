...
export class StaticContentStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props: StaticContentProps) {
         ...
         * Route53
         */
        const certificate = Certificate.fromCertificateArn(this, props.resourcePrefix + 'StaticContentCertificate', props.certificateArn);
         ...
         * S3 / CloudFront
         */
        const content = new Bucket(this, props.resourcePrefix + 'ClientContentBucket', {
            accessControl: BucketAccessControl.PRIVATE,
        });


        const angularSourceDir = '../../dist/champion-mvp-dev/browser';
        new BucketDeployment(this, props.resourcePrefix + 'ClientContentDeployment', {
        ...
        const originAccessIdentity = new OriginAccessIdentity(this, props.resourcePrefix + 'OriginAccessIdentity');
        ...
        */
         ...
         */
        let distribution = new Distribution(this, props.resourcePrefix + 'CloudFrontDistribution', {
        ...
        new CfnOutput(this, props.resourcePrefix + "ClientContentBucketOutput", {
            value: content.bucketArn,
            exportName: "ClientContentBucketArn"
        });
    }
}