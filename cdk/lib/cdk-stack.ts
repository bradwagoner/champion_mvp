    ...
    */
    ...
    const fitNestUserPoolClient = fitNestUserPool.addClient('fit-nest-app-client', {
      ...
      oAuth: {
        ...
        callbackUrls: [applicationBaseUrl, 'http://localhost:4200'], // todo - environment variables
        logoutUrls: [applicationBaseUrl, 'http://localhost:4200'], // todo - environment variables
      },
