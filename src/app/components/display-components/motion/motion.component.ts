...
@Component({
  selector: 'app-motion',
  standalone: true,
  imports: [CommonModule, FormsModule, KnobModule, ButtonModule, CardModule, ImageModule, FieldsetModule, EnumToStringPipe],
...
export class MotionComponent implements OnChanges {
  ...
  constructor(public assessmentService: AssessmentsService, public staticDataService: StaticDataService, public router: Router, public activatedRoute: ActivatedRoute) {
  }
